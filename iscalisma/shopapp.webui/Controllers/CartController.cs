...
namespace shopapp.webui.Controllers
{
    ...
    {
        //inject
       private ICartService _cartSerivce;
       private IOrderService _orderService;

       private UserManager<User> _userManager;
        public CartController(ICartService cartSerivce, UserManager<User> userManager, IOrderService orderService)
        {
        ...
        {
            var cart = _cartSerivce.GetCartByUserId(_userManager.GetUserId(User));
        ...
        public IActionResult AddToCart(int productId, int quantity)
        {
            ...
            _cartSerivce.AddToCart(userId, productId, quantity);
        ...
        {
            var userId = _userManager.GetUserId(User);
            _cartSerivce.DeleteFromCart(userId, productId);
            return RedirectToAction("Index");
        }
        //sipariş detay
        public IActionResult Checkout()
        {
            //kullanıcının kartını almak için
            var cart = _cartSerivce.GetCartByUserId(_userManager.GetUserId(User));
        ...
        public IActionResult Checkout(OrderModel model)
        {
            ...
            {
                var userId = _userManager.GetUserId(User);
                var cart = _cartSerivce.GetCartByUserId(userId);
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            request.ConversationId = new Random().Next(111111, 999999999).ToString();
